...
from sql2parquet.core.storage import upload_file_to_s3
from sql2parquet.core.storage import upload_folder_to_s3
...
class TestStorageFailures(unittest.TestCase):
    ...
    @patch("sql2parquet.core.storage.boto3")
...
class TestUploadFolder(unittest.TestCase):
    @patch("sql2parquet.core.storage.boto3.session.Session")
    @patch("sql2parquet.core.storage.os.walk")
