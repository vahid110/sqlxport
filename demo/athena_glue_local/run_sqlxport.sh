...
echo -e "\n🔹 [4/6] Exporting logs table to Parquet with partitioning..."
sqlxport run \
...
echo -e "\n🔹 [5/6] Previewing partitioned files with DuckDB (Athena-simulation)..."
